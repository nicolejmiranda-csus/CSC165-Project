 ...
 * A viewport is defined by specifying its left, bottom, width, and height
 * values.
...
public class Viewport {
	...
	/**
	 * returns the left-side relative position of this viewport in the window, as a
	...
	/**
	 * returns the bottom relative position of this viewport in the window, as a
	 * value between 0 and 1
	 */
	...
	/**
	 * returns the relative width of this viewport in the window, as a value between
	 * 0 and 1
	 */
	...
	/**
	 * returns the relative height of this viewport in the window, as a value
	 * between 0 and 1
	 */
	...
	/**
	 * returns a boolean that is true if a border has been specified for this
	 * viewport
	 */
	...
	/**
	 * returns a reference to the float array containing the border color of this
	 * viewport, if a border has been specified
	 */
	...
	/**
	 * sets RGB color values for the border of this viewport, if a border has been
	 * enabled
	 */
	...
	/** sets whether or not this viewport should be rendered */
	public void setEnabled(boolean e) {
		enabled = e;
	}

	/** returns whether or not this viewport should be rendered */
