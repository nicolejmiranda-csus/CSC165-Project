...
public class Camera
{
	...
	public void yaw(float radians)
	{
		...
		u.rotateAxis(radians, v.x(), v.y(), v.z());
		n.rotateAxis(radians, v.x(), v.y(), v.z());

		n.normalize();
		u.set(n.cross(v, new Vector3f())).normalize();   // u = n cross product v
	...
	public void pitch(float radians)
	{
		...
		v.rotateAxis(radians, u.x(), u.y(), u.z());
		n.rotateAxis(radians, u.x(), u.y(), u.z());
